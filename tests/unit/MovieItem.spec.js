...
describe("MovieItem.vue", () => {
  ...
  it("changes the class of the favourites button when the movie is removed from favourites", () => {});
  it("changes the class of the watchlist button when the movie is in watchlist", () => {});
  it("changes the class of the watchlist button when the movie is removed from watchlist", () => {});
  ...
  it("emits an event when the movie has been rated", () => {});
});
